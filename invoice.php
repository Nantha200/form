                ...
                <div class = "invoice-container">
                    <div class = "invoice-head">
                        <div class="invoice-head-top">
                            <div class="invoice-head-top-left text-start">
                                <div class=""><img src="nearlook logo.png" alt="Logo" width:50px; hight:50px></div>
                                
                            </div>
                        </div>
                        <div class = "invoice-head-middle" style="background-color:#FA6226;">
                            <div class = "invoice-head-middle-left text-start" >
                            <p ><span class = "text-bold">Invoice No:</span><?php echo $_GET['invoice']; ?></p>
                             
                            </div>
                            <div class = "invoice-head-middle-right text-end">
                            <p style="margin-top:-20px;"><span class = "text-bold">Date</span>: <?php echo date('d-m-y'); ?></p>
                            </div>
                        </div>
                        <div class = "hr"></div>
                        <div class = "invoice-head-bottom">
                            <div class = "invoice-head-bottom-left">
                                <ul style="margin-top:25px;">
                                    ...
                                    <?php 
                                    //SQL query for filtering name,address,phone
                            ...
                            <ul class="text-end" style="margin-top:-80px">
                                <h4 style="color:black;hight:10px">Pay To:</h4>
                                <label>Nearlook Mart Private Limited<br>184/F-31/1 Solaimalai Ayyanar Kovil Street,<br>Pugal Coffee opp Theni,Tamilnadu-625531<br>info@nearlook.com</label>
                    ...
                    <div class = "overflow-view">
                        <div class = "invoice-body">
                            <table>
                                <thead style="background-color:#FA6226;">
                                    <tr>
                                ...
                                <tbody>
                                    ...
                                    while($row=mysqli_fetch_assoc($query1)) {
                                     ...
                                     ?><tr>
                                        ...
                                        <td class = "text-end"><?php echo "Rs.".$row['total']; ?></td></tr>
                                        <?php } ?>
    ...
    padding: 27px 15px 27px 15px;
                            ...
                            <div class = "invoice-body-bottom">
                                ...
                                <div class = "invoice-body-info-item">
                                    <div class = "info-item-td text-end text-bold" style="background-color:#FA6226;">Grand Total : <?php echo "Rs.".$total; ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tm_note tm_text_center tm_font_style_normal" style="text-align:center">
                    <hr class="tm_mb15">
