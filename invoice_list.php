				...
				if (!$query) {
					...
					while ($row = mysqli_fetch_assoc($query)) {
						...
						while ($row1 = mysqli_fetch_assoc($query1)) {
							echo "<td>" . $row1['name'] . "</td> <td>" . $row1['phone'] . "</td><br>";
						}
						echo "<td>";
						...
						while ($row3 = mysqli_fetch_assoc($query3)) {
							echo $row3['price'] . "<br><br>";
						}
						echo "</td><td>";
						//SQL query for filtering all columns
						$sql4 = "SELECT * From invoice WHERE invoice_no='$invoice'";
						$query4 = mysqli_query($conn, $sql4);
						while ($row4 = mysqli_fetch_assoc($query4)) {
							echo $row4['quantity'] ."<br><br>";
						}
						echo"</td><td>";
						$sql4 = "SELECT * From invoice WHERE invoice_no='$invoice'";
						$query4 = mysqli_query($conn, $sql4);
						while ($row4 = mysqli_fetch_assoc($query4)) {
							echo $row4['total'] ."<br><br>";
						}
						echo"</td><td>";
						$sql4 = "SELECT * From invoice WHERE invoice_no='$invoice'";
						$query4 = mysqli_query($conn, $sql4);
						if ($row4 = mysqli_fetch_assoc($query4)) {
							echo $row4['subtotal'] ."<br><br>";
						}
						echo"</td><td>";
						$sql4 = "SELECT * From invoice WHERE invoice_no='$invoice'";
						$query4 = mysqli_query($conn, $sql4);
				...
				<!----------------- Buttons  --------------------->
						<td>
							<div style="display: flex;">
								...
								<div>
									<a href="delete.php?invoice=<?php echo $row['invoice_no'];?>"class="btn btn-primary edit"><svg xmlns="img/delete.svg" width="20" height="16" ></svg></a>
								</div>
								<div>
									<a href="update.php?invoice=<?php echo $row['invoice_no'];?>"class="btn btn-primary edit">update </a>
								</div>
